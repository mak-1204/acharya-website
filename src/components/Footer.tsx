          ...
          <div className="space-y-4 flex flex-col items-center sm:items-start">
            ...
            <div className="flex space-x-3">
              {[Instagram, Youtube, Facebook].map((Icon, i) => (
                <a key={i} href="#" className="w-8 h-8 rounded-full border border-white/20 flex items-center justify-center hover:bg-primary hover:border-primary transition-all">
